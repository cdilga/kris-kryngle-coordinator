...
**kris-kryngle-coordinator** - A web application where the user can enter a list of names of people participating in the Kris Kringle. The webapp randomly assigns each person another person they should buy presents for this holiday season.
...
**Platform**: Cloudflare Pages (static sites + functions)
...
Cloudflare Pages is perfect for static sites with optional serverless functions. Put static files in /public and API endpoints in /functions. Fast, global CDN distribution included.
